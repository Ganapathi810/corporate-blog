...
export function CategoryPostsClient({
    categorySlug,
    initialPosts,
}: {
    categorySlug: string;
    ...
    useEffect(() => {
        ...
        async function loadPosts() {
            try {
                ...
                // Use categorySlug by default, but if user picks a different category filter, use categoryId
                if (category) {
                    query.append("categoryId", category);
                } else {
        ...
        loadPosts();
    },[search, category, sort, categorySlug, hasFilters])
